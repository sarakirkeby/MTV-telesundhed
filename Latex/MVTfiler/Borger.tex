...
\section{Målgruppe}
\label{sec:mgruppe}
Målgruppen er borgere i ældregruppen visiteret til hjemmepleje karakteriseret ved, at hjemmeplejen i realiteten ikke kræver fysisk tilstedeværelse af en sundhedsprofessionel. Ergo er målgruppen ældre borgere, der modtager hjælp til at udføre opgaver, som disse med rette påmindelse og støtte selv kan udføre. Denne mini-MTV læner sig op ad Kommunernes Landsforening og afgrænser ”ældre” til at omfatte borgere på 65 år eller derover \cite{KL}. 
...
\section{Metode}
Data og informationer anvendt i borgerkapitlet er indhentet ved litteraturstudie i videnskabelige databaser, generel dataindsamling samt empirisk dataindsamling i form af en interviewundersøgelse fra \textit{Pilotprojekt Videokommunikation} fra Sundhedscenter Hadsten. For en dybdegående beskrivelse af metoden henvises til bilag [Bilag 16, 16.1].
...
Resultater tyder på en høj tilfredshed blandt borgere, der har modtaget virtuel hjemmepleje i form af videoopkald. Ifølge et systematisk review \textit{Virtual Visits in Home Health Care for Older Adults} var tilfredsheden med kvaliteten i hjemmeplejen højere blandt borgere, der modtog virtuel hjemmepleje sammenlignet med borgere, der modtog fysisk hjemmepleje \cite{Baf2}. Ligeledes viste et pilotstudie fra 2009 blandt ni borgere høj grad af tilfredshed med levering af virtuel hjemmepleje i en periode på seks måneder. Fem ud af otte adspurgte borgere var meget tilfredse og de resterende tre borgere noget tilfredse med videoopkaldene. Ingen af de deltagende borgere var neutrale eller utilfredse med videoopkaldene \cite{wade}.
...
I modsætning hertil blev der i et systematisk review \textit{Telemedicine versus face to face patient care: Effects on professional practice and health care outcomes} ikke fundet signifikant forskel på tilfredsheden blandt modtagere af virtuelle besøg sammenlignet med modtagere af fysiske besøg \cite{Paf2}. 
\\Samme resultat fremkom fra et mixed methods-studie \textit{Evaluering og dokumentation af telesundhed i kommunal hjemmepleje/sygepleje} fra Viborg Kommune om borgeres tilfredshed samt oplevelser med virtuel hjemmepleje ved medicinadministration sammenlignet med fysiske besøg. I dette studie blev der ikke fundet signifikant forskel i den samlede tilfredshedsscore blandt borgere, der modtog virtuel hjemmepleje og borgere, der modtog fysiske besøg \cite{kandidat}.

\subsection{Borgeraccept}
Borgeraccept retter fokus mod, hvorvidt borgerne accepterede anvendelsen af videoopkald som alternativ til fysiske besøg. Et systematisk review \textit{Telenursing for the elderly. The case for care via video-telephony} havde til formal at diskutere mulighederne for anvendelsen og levering af virtuel hjemmepleje via videotelefoni. Her blev det påpeget, at videotelefoni blev taget godt imod på baggrund af den visuelle kontakt \cite{telenursing}. I forlængelse heraf viste resultater fra dette systematiske review, at borgeraccepten voksede proportionalt med erfaring med videoopkaldene. Jo bedre erfaring med teknologien blandt borgerne, desto større accept af denne \cite{telenursing}.
...
I et pilotprojekt \textit{Videophone delivery of medication management in community nursing} var det muligt for en borger at modtage videoopkald før arbejdets start, hvorved følelsen af frihed og fleksibilitet ved virtuelle hjemmeplejebesøg var større end ved fysiske besøg \cite{wade}. Dog er målgruppen i denne mini-MTV uden for den erhvervsaktive alder, men pilotprojektet underbygger muligheden for fleksibilitet ved videoopkald. 
 
Resultater fra et pilotprojekt i Viborg Kommune gennemført i perioden 2013-2014 med afprøvning af videoopkald som alternativ til fysiske besøg viste, at borgeren oplevede en mindre grad af stigmatisering, idet virtuel hjemmepleje muliggjorde diskretion for borgeren. Borgeren kunne i fuld fortrolighed modtage konkrete ydelser, uden at hjemmeplejerens bil var parkeret uden for borgerens hus \cite{kandidat}.
...
Ifølge det systematiske review \textit{Virtual Visits in Home Health Care for Older Adults} oplevede borgerne en koncentreret kommunikation med sygeplejerskerne. Følelsen af personlig kontakt var højere blandt borgere, der modtog virtuelle besøg sammenlignet med borgere, der modtog fysiske besøg \cite{Baf2}. 
...
Det kan endvidere konkluderes, at borgeraccepten af virtuel hjemmepleje med videoopkald i Favrskov Kommune har været stor. Borgerne i interviewundersøgelsen har været positive, og betydningen af virtuel hjemmepleje har medført positive reaktioner. Virtuel hjemmepleje har medvirket til en følelse af frihed blandt borgerne i Favrskov Kommune.
